...
<div class="block">
				<div class="block_head">
					...
					<h2>YENİ KÜNYE BİLGİSİ OLUŞTUR</h2>
...
<p>
	<?php echo $this->Form->input('name',Array('label'=>Array('text' =>'Künye Başlığı :','class' => 'req'),'class' => 'text medium big','autocomplete' => 'off','between' => '<br/>','error' => array('wrap' => 'span','class' => 'note error')));?>
</p>
<div id="datas">
