<div class="block">
	<div class="block_head">
		...
		<h2>Resİm Tİplerİ</h2>
        <ul>
			<li><?php echo $this->Html->link('Resİm tİpİ ekle',Array('controller' => 'image_types','action' => 'add'))?></li>
			<li><?php echo $this->Html->link('Resİm boyutlarI',Array('controller' => 'image_sizes','action' => 'index'))?></li>
		</ul>
	</div>		<!-- .block_head ends -->
